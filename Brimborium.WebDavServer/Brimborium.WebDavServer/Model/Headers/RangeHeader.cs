...
namespace Brimborium.WebDavServer.Model.Headers {
    ...
    public class RangeHeader {
        ...
        private RangeHeader(string unit, bool ignoreInvalidUnit, IReadOnlyCollection<RangeHeaderItem> rangeItems) {
            ...
            this.Unit = string.IsNullOrEmpty(unit) ? "bytes" : unit;
            this.RangeItems = rangeItems.ToList();
        }
        ...
        public override string ToString() {
            return $"{this.Unit}={string.Join(",", this.RangeItems.Select(x => x.ToString()))}";
        }
        ...
        public virtual string ToString(RangeHeaderItem rangeItem) {
            return this.ToString(rangeItem, null);
        }
        ...
        public virtual string ToString(RangeHeaderItem rangeItem, long? length) {
            return $"{this.Unit} {rangeItem}/{length?.ToString(CultureInfo.InvariantCulture) ?? "*"}";
        }
        ...
        public IReadOnlyList<NormalizedRangeItem> Normalize(long totalLength) {
            var rangeItems = this.RangeItems.Select(x => x.Normalize(totalLength))
