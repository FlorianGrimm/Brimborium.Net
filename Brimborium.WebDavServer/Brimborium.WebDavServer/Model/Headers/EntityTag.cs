...
namespace Brimborium.WebDavServer.Model.Headers {
    ...
    public struct EntityTag : IEquatable<EntityTag> {
        ...
        public EntityTag AsStrong() {
            return new EntityTag(false, this.Value);
        }
        ...
        public EntityTag AsWeak() {
            return new EntityTag(true, this.Value);
        }
        ...
        public EntityTag Update() {
            return new EntityTag(this.IsWeak, Guid.NewGuid().ToString("D"));
        }
        ...
        public XElement ToXml() {
            return new XElement(GetETagProperty.PropertyName, this.ToString());
        }
        ...
        public override string ToString() {
            ...
            result.Append('"').Append(this.Value.Replace("\"", "\"\"")).Append('"');
        ...
        public override bool Equals(object? obj) {
            return obj is EntityTag && this.Equals((EntityTag)obj);
        }

        /// <inheritdoc />
        public override int GetHashCode() {
            return this.Value.GetHashCode()
                ^ this.IsWeak.GetHashCode();
        }
