...
namespace Brimborium.WebDavServer.Utils.UAParser
{
    #region Imports
    ...
    public sealed class Parser
    {
        ...
        {
            using (var stream = typeof(Parser).GetTypeInfo().Assembly.GetManifestResourceStream($"{typeof(Parser).Namespace}.UAParser.regexes.yaml"))
