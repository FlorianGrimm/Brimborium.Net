...
namespace Brimborium.CodeFlow.RequestHandler {
    public abstract class RequestHandlerResultConverterSpecialized<TRequestHandlerResult>
        : IRequestHandlerResultConverterSpecialized<TRequestHandlerResult>
        where TRequestHandlerResult : RequestHandlerResult {

        public RequestHandlerResultConverterSpecialized() {
        }

        public virtual ActionResult ConvertToActionResult(ControllerBase controllerBase, RequestHandlerResult requestResult) {
