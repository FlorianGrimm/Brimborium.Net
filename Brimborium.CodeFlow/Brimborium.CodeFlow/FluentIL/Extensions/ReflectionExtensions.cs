namespace Brimborium.CodeFlow.FluentIL {
    ...
    using Brimborium.CodeFlow.Extensions;
    ...
    public static class ReflectionExtensions {
        ...
        public static Action<T> GetMethodAction<T>(this object instance, string methodName) {
            var methodInfo = instance.GetType().GetMethod(methodName, new[] { typeof(T) }).EnsureNotNull();
        ...
        public static Action<T1, T2> GetMethodAction<T1, T2>(this object instance, string methodName) {
            var methodInfo = instance.GetType().GetMethod(methodName, new[] { typeof(T1), typeof(T2) }).EnsureNotNull();
        ...
        public static Action<T1, T2, T3> GetMethodAction<T1, T2, T3>(this object instance, string methodName) {
            var methodInfo = instance.GetType().GetMethod(methodName, new[] { typeof(T1), typeof(T2), typeof(T3) }).EnsureNotNull();
        ...
        public static Action<T1, T2, T3, T4> GetMethodAction<T1, T2, T3, T4>(this object instance, string methodName) {
            var methodInfo = instance.GetType().GetMethod(methodName, new[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4) }).EnsureNotNull();
        ...
        public static Func<TResult> GetMethodFunc<TResult>(this object instance, string methodName) {
            var methodInfo = instance.GetType().GetMethod(methodName, Type.EmptyTypes).EnsureNotNull();
