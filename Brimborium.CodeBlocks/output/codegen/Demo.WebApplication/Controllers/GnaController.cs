    ...
    public sealed class GnaController
        ...
        public System.Threading.Tasks.Task<Microsoft.AspNetCore.Mvc.ActionResult> PostAsync(
            ...
            try {
                ...
                Brimborium.CodeFlow.RequestHandler.RequestResult<Demo.Server.GnaServerPostResponse>response = await service.GetAsync(request, requestAborted);
                Microsoft.AspNetCore.Mvc.ActionResult actionResult = this._RequestServices.GetRequiredService<IActionResultConverter>()
                    .ConvertToActionResult<Demo.Server.GnaServerPostResponse>(this, response);
                return actionResult;
            } catch (System.Exception error) {
        ...
        public System.Threading.Tasks.Task<Microsoft.AspNetCore.Mvc.ActionResult> PostNameAsync(
            ...
            try {
                ...
                Brimborium.CodeFlow.RequestHandler.RequestResult<Demo.Server.GnaServerPostNameResponse>response = await service.GetAsync(request, requestAborted);
                Microsoft.AspNetCore.Mvc.ActionResult actionResult = this._RequestServices.GetRequiredService<IActionResultConverter>()
                    .ConvertToActionResult<Demo.Server.GnaServerPostNameResponse>(this, response);
                return actionResult;
            } catch (System.Exception error) {
