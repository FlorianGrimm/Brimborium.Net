...
public static class AzureAppServicesLoggerFactoryExtensions {
    ...
    public static ILoggingBuilder AddAzureWebAppDiagnostics(this ILoggingBuilder builder) {
        ...
        return builder.AddAzureWebAppDiagnostics(context, _ => { });
    }
    ...
    public static ILoggingBuilder AddAzureWebAppDiagnostics(this ILoggingBuilder builder, Action<AzureBlobLoggerOptions> configureBlobLoggerOptions) {
        ...
        // Only add the provider if we're in Azure WebApp. That cannot change once the apps started
        return builder.AddAzureWebAppDiagnostics(context, configureBlobLoggerOptions);
    }

    public static ILoggingBuilder AddAzureWebAppDiagnostics(this ILoggingBuilder builder, IWebAppContext context, Action<AzureBlobLoggerOptions> configureBlobLoggerOptions) {        
