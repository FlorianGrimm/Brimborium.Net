...
public static partial class MayBeExtensions {
    public static MayBe<V, F> Switch<V, F>(
        this MayBe<V, F> that,
    ...
    public static MayBe<V, F> SwitchOn<V, F, Args>(
        this MayBe<V, F> that,
        Args args,
    ...
    //
    public static async Task<MayBe<V, F>> SwitchAsync<V, F>(
        this MayBe<V, F> that,
    ...
    //
    public static async Task<MayBe<V, F>> SwitchOnAsync<V, F, Args>(
        this MayBe<V, F> that,
        Args args,
